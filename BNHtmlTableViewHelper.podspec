#
#  Be sure to run `pod spec lint BNHtmlTableViewHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author       = { "targuy" => "email@address.com" }
  # s.authors      = { "targuy" => "email@address.com", "other author" => "email@address.com" }
  # s.author       = 'targuy', 'other author'
